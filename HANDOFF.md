...
| `DESIGN-SYSTEM.md`              | Every component resolved to pixels and hex, for rebuilding the library as a design file. Generated by `bun run design-system`, which measures the real components in a browser rather than transcribing the stylesheet |
