...
- [ ] **Phase 8 — Release:** `1.0.0-beta.0` published under the `beta` dist-tag, verified by installing it from the registry. `latest` stays on `0.23.0` until the stable release.
